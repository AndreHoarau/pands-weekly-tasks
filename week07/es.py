...
# I also read the W3 Schools piece on files here: https://www.w3schools.com/python/python_file_handling.asp
...
letter = sys.argv[1]
filename =sys.argv[2]
# If the file name does not exist we handle the error like this
if not os.path.exists(filename):
    print("This file name does not exist")
    sys.exit(1)
# If it is not a text file we handle it like this.
